    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<JournalLayout />}>
          <Route path="/journals" element={<JournalsPage />} />
          <Route path="/journals/:journalUrl" element={<Navigate to="home" replace />} />
          {/* ✅ :articleParam accepts both title slugs and IDs (backwards compatible) */}
          <Route path="/journals/:journalUrl/article-in-press/:articleParam/abstract" element={<JournalArticleAbstractPage />} />
          <Route path="/journals/:journalUrl/article-in-press/:articleParam/pdf" element={<ArticlePdfViewerPage />} />
          <Route path="/journals/:journalUrl/archive/:year/:volume/:issueNumber" element={<JournalArchiveIssuePage />} />
          <Route path="/journals/:journalUrl/:section" element={<JournalShell />} />
        </Route>
