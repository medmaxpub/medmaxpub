      ...
      <div className="container-shell flex flex-col gap-4 py-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <a href="/" className="flex items-center">
            <img src="/medmax-logo.png" alt="Medmax Publishers" className="h-16 w-auto sm:h-20" />
          </a>
        </div>

        <form
          onSubmit={onSearch}
          className="flex w-full max-w-2xl items-center gap-2 rounded-full border border-brand-sky bg-brand-mist px-3 py-2"
        >
