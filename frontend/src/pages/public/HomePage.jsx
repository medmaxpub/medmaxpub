      ...
      <section className="bg-white">
        <div className="container-shell py-10 lg:py-14">
          <div className="overflow-hidden rounded-[2rem] border border-brand-sky bg-white shadow-panel">
            ...
            <div className="border-t border-brand-sky bg-white px-4 py-8 sm:px-6 sm:py-10 lg:px-10">
              <div className="mx-auto max-w-4xl text-center">
                ...
                <p className="mx-auto mt-4 max-w-3xl text-sm leading-7 text-slate-700 sm:mt-5 sm:text-lg sm:leading-8">
        ...
        <div className="container-shell">
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {scientificReach.map((item) => (
              <div key={item.title} className="card-panel p-5 sm:p-6">
